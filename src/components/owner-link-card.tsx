 ...
 *
 * Shown on a desktop, where they are building the page — so the link is a QR
 * to scan rather than something to retype. Scanning signs that phone in once;
 * adding it to the home screen is what keeps it signed in, puts the icon next
 * to Instagram, and (on iOS) is the only way we are ever allowed to send them
 * a notification.
 *
 * The instructions are spelled out because "add to home screen" is buried in
 * a share sheet and most people have never deliberately done it.
 */
